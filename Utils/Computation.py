...
from Utils import Computation_Functions
...
def switch(operator, value_a, value_b):
    if operator == "x":
        result = Computation_Functions.multiplication(value_a, value_b)
        STACK.append(result)

    if operator == "-":
        result = Computation_Functions.subtraction(value_a, value_b)
        STACK.append(result)

    if operator == "/":
        result = Computation_Functions.division(value_a, value_b)
        STACK.append(result)

    if operator == "+":
        result = Computation_Functions.addition(value_a, value_b)
        STACK.append(result)
