...
sys.path.insert(1, 'PycharmProjects/PolishNotation/Utils')
...
def handle_client(connection, address):
    ...
    while connected:
        ...
        if msg_length:  # Check if the msg has content - first msg is always blank on connection
            ...
            computation_obj = Computation.start_computation(user_input)  # Make a new computation object and pass the user_input
